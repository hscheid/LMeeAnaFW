...
AliAnalysisTaskElectronEfficiencyV2* Config_sscheid_efficiencyV2 (TString name, int wagonnr);
...
// TString names=("noPID;cut5_pt200;kPbPb2015_Pt200_PID_cutoff_pion_kaon_proton;cut5_pt200_TOFreq");
// TString names=("cut5_pt200;cut5_pt200_0SITS;cut5_pt200_woSITS");
// TString names=("cut0_resolution;cut1_ana");
...
// TString names("aodTrackCuts01;aodTrackCuts02;aodTrackCuts03;aodTrackCuts04;aodTrackCuts05;aodTrackCuts06;aodTrackCuts07;aodTrackCuts09;aodTrackCuts09;aodTrackCuts10");
...
// TString generatorNameForMCSignal = "Hijing_0;Jpsi2ee_1";
...
AliAnalysisFilter* SetupCuts(Int_t cutDefinition)
{
  ...
  //for resolution maps: dont use PID cuts
  // if (cutDefinition != 0) die->AddCuts(SetupPIDcuts(cutDefinition));
