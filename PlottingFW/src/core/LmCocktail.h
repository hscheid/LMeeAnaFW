...
public:
  ...
  void          SetLFscaling(Double_t scaling)    { fLFscaling   = scaling; }
...
//  LmCocktailPart*               GetLmCocktailPartCopy(Int_t partType);
  ...
  enum enSystem { // just extend the list as needed...
    ...
    kpp_MB_13pythia,    ///< pp, Min.Bias, 13 TeV values from 13 TeV dielectron nominal field HF fit publication
    kpp_MB_13powheg,    ///< pp, Min.Bias, 13 TeV values from 13 TeV dielectron nominal field HF fit publication
